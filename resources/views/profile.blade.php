                            ...
                            <div class="report-section1">
                                ...
                                <div class="report-content google-report" id="googleReportContent">
                                    ...
                                    <div class="input-analysis">
                                        ...
                                        <p class="analysis-text"><span class="red-dot"></span> The text is likely to be
                                            copied. Here are some sources where it was found:</p>
                                    </div>
                    ...
                    <div class="main-content">
                        <div class="code-input">
                            ...
                            <div id="codeEditorContainer" class="code-editor-container">
                                ...
                                <div id="codeEditor" class="editor-area" contenteditable="true" spellcheck="false">
                                </div>
                            </div>
                        ...
                        <div class="report-section">
                            <div id="reportCard" class="report-card hidden">
                                ...
                                <div class="report-item">
                                    ...
                                    <div class="plagiarism-status not-plagiarized" id="plagiarismStatus">Not Plagiarized
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="text-compare" class="content-div" style="display: none;">
                <div class="main-container">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="report-section3" id="report-section">
                            <div class="report-container">
                                ...
                                <div class="section">
                                    ...
                                    <p class="alert">*** POTENTIAL PLAGIARISM DETECTED between Document 1 and Document 2
                                        (82.93%) ***</p>
                                    <p class="highlight">Most similar pair: Document 1 and Document 2 (82.93%)</p>
                                    <p class="highlight" id="least-similar-semantic">Least similar pair: Document 2 and
                                        Document 3 (60.64%)</p>
