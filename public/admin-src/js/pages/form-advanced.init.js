...
!function (t) {
    ...
    e.prototype.initSelect2 = function () {
        ...
        this.initSelect2(), this.initMaxLength(), this.initSelectize(), this.initSwitchery(), this.initMultiSelect(), this.initTouchspin(), window.addEventListener("resize", function () {
            var e = document.body.querySelectorAll("span"), e = e[e.length - 1];
            "-99999px" == e.style.top && e.remove()
        })
    }, t.FormAdvanced = new e, t.FormAdvanced.Constructor = e
}(window.jQuery), window.jQuery.FormAdvanced.init(), $(function () {
    var n = $.map(countries, function (e, a) {
        return {value: e, data: a}
    });
    $("#autocomplete-ajax").autocomplete({
        lookup: n, lookupFilter: function (e, a, i) {
    ...
    $("#autocomplete").devbridgeAutocomplete({
        lookup: a, minChars: 1, onSelect: function (e) {
